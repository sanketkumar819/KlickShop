# Generated by Django 3.2.8 on 2022-04-07 08:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mobile'), ('L', 'Laptop'), ('TW', 'Top Wear'), ('BW', 'Bottom Wear'), ('S', 'Speaker')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cutomer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.cutomer')),
